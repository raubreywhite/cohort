...
[![CRAN
status](https://www.r-pkg.org/badges/version/cohort)](https://cran.r-project.org/package=cohort)
...
`cp$get_artifact("adults_female", "<artifact>")` and pass them straight
into whatever consumes analytic data.

## Documentation

- [Introduction
  vignette](https://www.rwhite.no/cohort/articles/cohort.html)
