...
```{r consort, fig.width = 7, fig.height = 6, fig.align = "center", out.width = "85%"}
cp$draw_consort_panels(
  panels = list(
    "Adult-female analytic chain" = c(
...
To save to disk, pass `file = "Figure_1_CONSORT.pdf"` (`.pdf` and
`.png` are supported). The same call accepts a list of panels for
multi-panel figures.
